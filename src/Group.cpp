...
Group::Group(int N) {
    ...
    // Pre-allocate all generators in one contiguous vector — no double indirection
    t.assign(nGen, Matrix(Nc));           // 2x2 for SU(2), 3x3 for SU(3)
    tA.assign(nGen, Matrix(Nc * Nc - 1, 0.)); // 3x3 for SU(2), 8x8 for SU(3)
    if (Nc == 2) {
        // fundamental rep.
        t[0].set(0, 0, 0.);
        t[0].set(0, 1, 0.5);
        ...
        constexpr double sqrt3o2 = 0.8660254037844386;  // sqrt(3)/2
        // fundamental rep.
        t[0].set(0, 0, 0.);
        t[0].set(0, 1, 0.5);
        t[0].set(0, 2, 0.);
        ...
        tA[4].set(3, 7, complex<double>(0., sqrt3o2));
        tA[4].set(5, 0, complex<double>(0., 0.5));
        tA[4].set(6, 1, complex<double>(0., -0.5));
        tA[4].set(7, 3, complex<double>(0., -sqrt3o2));
        ...
        tA[5].set(6, 7, complex<double>(0., -sqrt3o2));
        tA[5].set(7, 6, complex<double>(0., sqrt3o2));
        ...
        tA[6].set(5, 7, complex<double>(0., sqrt3o2));
        tA[6].set(7, 5, complex<double>(0., -sqrt3o2));

        // tA8
        tA[7].set(3, 4, complex<double>(0., -sqrt3o2));
        tA[7].set(4, 3, complex<double>(0., sqrt3o2));
        tA[7].set(5, 6, complex<double>(0., -sqrt3o2));
        tA[7].set(6, 5, complex<double>(0., sqrt3o2));
    } else {
